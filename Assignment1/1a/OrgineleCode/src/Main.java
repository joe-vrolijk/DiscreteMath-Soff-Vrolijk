...
Main {
    ...
    public static void main(String[] args) {
         ...
         * @author:JoeVrolijk
         * groep: ID1S1
         * studentnummer: 500791806
         * opdracht: BSA Monitor 3.0
         * functie: Geeft een BSA advies.
         */
    ...
    public static void printOutput(Vak[] vakken) {
        for (int i = 0; i < vakken.length; i++) {
            System.out.printf("%-13s%-26s %-8s%-5.1f%-17s%-2d%n", "Vak/project: ", vakken[i].getNaam(), "Cijfer: ", vakken[i].getCijfer(), " Behaalde Punten:", vakken[i].gehaaldePunten());
        }
